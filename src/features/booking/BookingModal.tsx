...
const BookingModal = ({ provider, open, onClose }: BookingModalProps) => {
  ...
  const rate = provider.discountRate ?? provider.hourlyRate;
      ...
      <DialogContent className="max-w-md p-0 overflow-hidden gap-0">
        ...
        <div className="flex items-center gap-3 border-b border-border p-4">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-sm font-bold text-card-foreground truncate">{provider.name}</p>
            <p className="text-xs text-muted-foreground">
              {step === "review" ? "How was your session?" : `$${rate}/hr session`}
            </p>
          </div>
          {provider.satisfactionGuarantee && step !== "review" && (
              ...
              <div className="border-t border-border pt-3 flex justify-between text-sm">
                ...
                <div className="text-right">
                  {provider.discountRate && (
                    <span className="text-xs text-muted-foreground line-through mr-2">${provider.hourlyRate}</span>
                  )}
          ...
          <div className="p-8 text-center space-y-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground mt-1">
                Your session with {provider.name} is booked for {selectedDay} at {selectedTime}.
              </p>
            </div>
            <p className="text-xs text-muted-foreground">
        ...
        {step === "review" && reviewSubmitted && (
          <div className="p-8 text-center space-y-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground mt-1">
                Your feedback helps {provider.name} grow and helps other students make confident choices.
              </p>
            </div>
