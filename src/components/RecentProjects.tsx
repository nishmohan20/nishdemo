import { Calendar, Clock, User, Award, ArrowLeft, Folder } from "lucide-react";
import { Badge } from "@/components/ui/badge";
import type { RecentProject } from "@/data/instructors";
...
const RecentProjects = ({ projects, instructorName, onBack }: RecentProjectsProps) => {
  return (
    <div className="flex flex-col gap-4 p-6">
      ...
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-0.5">
          {projects.length} completed project{projects.length !== 1 ? "s" : ""} by {instructorName}
        </p>
      </div>
